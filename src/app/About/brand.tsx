...
const Brand = () => {
  return (
    <div className="w-full bg-[#FAFAFA] py-10 flex flex-col gap-[60px]">
      {/* Header Section */}
      <div className="text-center px-4 flex gap-[30px] flex-col ">
        <h2 className="font-bold text-[28px] lg:text-[40px] text-[#252B42] leading-[36px] lg:leading-[50px] tracking-[0.2px]">
          Big Companies Are Here
        </h2>
        <p className="text-[#737373] font-normal text-[14px] lg:text-[16px] leading-[20px] lg:leading-[24px] mt-4">
      ...
      <div className="md:h-[175px] h-[1073px] relative bg-[#fafafa]">
      <div className="absolute  md:top-[0px] flex flex-col md:flex-row lg:left-[195px] items-center justify-center md:justify-between gap-[60px] lg:gap-[30px]  md:w-[1050px] w-full">
        {/* Image 1 */}
