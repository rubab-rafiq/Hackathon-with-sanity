...
const ClassicProduct = () => {
  return (
    ...
    <div className='lg:w-[1036px] lg:h-[711px] lg:left-[209px]  left-[30px] absolute gap-[80px]  py-[112px] w-[414px] h-[1252px]  overflow-hidden'>
      <div className=' gap-[30px]   h-[1238px] w-[1049px]  grid grid-flow-cols-1 lg:grid-cols-2'>
        ...
        <div className=' w-[443px] h-[635px]'>
         <Image src={Classicproduct} alt="Classicproduct" className='w-[443px] h-[635px]' />
        </div>
      </div>
    </div>
  </div>
