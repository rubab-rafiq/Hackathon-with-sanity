      ...
      <div className='w-full lg:w-[1124px] mx-auto flex-col py-[80px] gap-[80px] flex relative'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[30px]'>
          ...
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img1} alt="img1" className='w-full h-[427px] object-cover' />
          ...
          {/* Product 2 */}
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img2} alt="img2" className='w-full h-[427px] object-cover' />
            <div className='w-full px-[25px] pt-[25px] pb-[35px] flex flex-col items-center'>
              <h5 className='text-[16px] font-bold text-[#252B42] leading-[24px] tracking-[0.1px]'>Graphic Design</h5>
              <p className='text-[14px] font-bold text-[#737373] leading-[24px] tracking-[0.2px]'>English Department</p>
              <p className='text-[16px] font-bold text-[#BDBDBD] leading-[24px] tracking-[0.1px]'>$16.48 <span className='text-[#238560]'>$6.48</span></p>
          ...
          {/* Product 3 */}
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img3} alt="img3" className='w-full h-[427px] object-cover' />
            <div className='w-full px-[25px] pt-[25px] pb-[35px] flex flex-col items-center'>
              <h5 className='text-[16px] font-bold text-[#252B42] leading-[24px] tracking-[0.1px]'>Graphic Design</h5>
              <p className='text-[14px] font-bold text-[#737373] leading-[24px] tracking-[0.2px]'>English Department</p>
              <p className='text-[16px] font-bold text-[#BDBDBD] leading-[24px] tracking-[0.1px]'>$16.48 <span className='text-[#238560]'>$6.48</span></p>
          ...
          {/* Product 4 */}
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img4} alt="img4" className='w-full h-[427px] object-cover' />
            <div className='w-full px-[25px] pt-[25px] pb-[35px] flex flex-col items-center'>
              <h5 className='text-[16px] font-bold text-[#252B42] leading-[24px] tracking-[0.1px]'>Graphic Design</h5>
              <p className='text-[14px] font-bold text-[#737373] leading-[24px] tracking-[0.2px]'>English Department</p>
              <p className='text-[16px] font-bold text-[#BDBDBD] leading-[24px] tracking-[0.1px]'>$16.48 <span className='text-[#238560]'>$6.48</span></p>
       ...
       <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[30px]'>
          {/* Product 1 */}
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img5} alt="img5" className='w-full h-[427px] object-cover' />
            <div className='w-full px-[25px] pt-[25px] pb-[35px] flex flex-col items-center'>
              <h5 className='text-[16px] font-bold text-[#252B42] leading-[24px] tracking-[0.1px]'>Graphic Design</h5>
              <p className='text-[14px] font-bold text-[#737373] leading-[24px] tracking-[0.2px]'>English Department</p>
              <p className='text-[16px] font-bold text-[#BDBDBD] leading-[24px] tracking-[0.1px]'>$16.48 <span className='text-[#238560]'>$6.48</span></p>
          ...
          {/* Product 2 */}
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img6} alt="img6" className='w-full h-[427px] object-cover' />
            <div className='w-full px-[25px] pt-[25px] pb-[35px] flex flex-col items-center'>
              <h5 className='text-[16px] font-bold text-[#252B42] leading-[24px] tracking-[0.1px]'>Graphic Design</h5>
              <p className='text-[14px] font-bold text-[#737373] leading-[24px] tracking-[0.2px]'>English Department</p>
              <p className='text-[16px] font-bold text-[#BDBDBD] leading-[24px] tracking-[0.1px]'>$16.48 <span className='text-[#238560]'>$6.48</span></p>
          ...
          {/* Product 3 */}
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img7} alt="img7" className='w-full h-[427px] object-cover' />
            <div className='w-full px-[25px] pt-[25px] pb-[35px] flex flex-col items-center'>
              <h5 className='text-[16px] font-bold text-[#252B42] leading-[24px] tracking-[0.1px]'>Graphic Design</h5>
              <p className='text-[14px] font-bold text-[#737373] leading-[24px] tracking-[0.2px]'>English Department</p>
              <p className='text-[16px] font-bold text-[#BDBDBD] leading-[24px] tracking-[0.1px]'>$16.48 <span className='text-[#238560]'>$6.48</span></p>
          ...
          {/* Product 4 */}
          <div className='w-full bg-[#FFFFFF]'>
            <Image src={img8} alt="img8" className='w-full h-[427px] object-cover' />
            <div className='w-full px-[25px] pt-[25px] pb-[35px] flex flex-col items-center'>
              <h5 className='text-[16px] font-bold text-[#252B42] leading-[24px] tracking-[0.1px]'>Graphic Design</h5>
              <p className='text-[14px] font-bold text-[#737373] leading-[24px] tracking-[0.2px]'>English Department</p>
              <p className='text-[16px] font-bold text-[#BDBDBD] leading-[24px] tracking-[0.1px]'>$16.48 <span className='text-[#238560]'>$6.48</span></p>
