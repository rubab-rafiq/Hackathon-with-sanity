...
const Universe = () => {
  return (
    <div className='lg:h-[716px] lg:w-auto  h-[1366px]  bg-[#FFFFFF] relative '>
    
    <div className='lg:w-[1036px] lg:h-[711px] left-[30px] lg:left-[200px] absolute gap-[80px]  py-[112px] w-[414px] h-[1252px]'>
      ...
      <div className=' w-[443px] h-[635px]'>
        ...
        <div className='lg:w-[509px] lg:h-[432px] lg:gap-[30px]   h-[429px] gap-[35px] text-[black] flex flex-col'>
          ...
          $16.48 <span className="bg-[#2DC071] py-3 text-[14px] h-[52px] w-full lg:w-[184px] rounded inline-block">
                  ADD TO CART
                </span>
          </button>
        </div>
