...
//           ))
//         ) : (
//           <div className="flex flex-col items-center justify-center h-96"><h1 className="text-2xl font-bold mb-6 text-gray-800">Your cart is empty</h1>

//           <p><Link href="/Shop " className="bg-[#23A6F0] p-2 rounded-md  text-white text-extra-bold text-2xl text center">Continue Shopping</Link></p></div>
